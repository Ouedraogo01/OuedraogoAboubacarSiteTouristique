...
<body>
    ...
    <section>
        ...
        <div>
            <h2 class="text-center mt-5 bg-success">Transports</h2>
            <div class="card-group">
                ...
                while ($donnees = $impho->fetch()) {
                    ...
                    <div class="card m-3 mt-5">
                        <img src="service/<?php echo $donnees["photo"] ?>" class="card-img-top" alt="...">
                        <div class="card-body">
        ...
        <div>
            <h2 class="text-center mt-5 bg-success">Hébergements & séjours</h2>
            <div class="card-group">
                <?php
    ...
    <section>
        <h2 class="text-center mt-5 bg-success">Localisation</h2>
        <div class="cartes">
